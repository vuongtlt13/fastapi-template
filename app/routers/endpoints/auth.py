...
def login_access_token(
        db: Session = Depends(common.get_db), form_data: OAuth2PasswordRequestForm = Depends()
) -> Any:
    """
...
def test_token(current_user: models.User = Depends(common.get_current_user)) -> Any:
    """
    Test access token
    """
    return current_user
